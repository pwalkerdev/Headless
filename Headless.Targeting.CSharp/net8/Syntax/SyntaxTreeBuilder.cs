...
@"namespace {{NAMESPACE_NAME}}
{
    public static class {{CLASS_NAME}}
    {
        ...
        var script = template.Replace("{{NAMESPACE_NAME}}", "Headless.Framework")
...
@"namespace {{NAMESPACE_NAME}}
{
    ...
    private static SyntaxTree BuildSyntaxTree(string script, CSharpParseOptions options) => SyntaxFactory.ParseSyntaxTree(script, options);
}