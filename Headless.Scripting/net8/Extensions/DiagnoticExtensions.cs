...
internal static class DiagnoticExtensions
{
    ...
    public static IEnumerable<Diagnostic> Errors(this IEnumerable<Diagnostic> results) => results.Where(DiagnoticExtensions.IsError);
